...
![HTML code](/images/2025-01-18-Flare-On-2014-C2/1.png)

Upon checking the `flare-on.png`, it revealed an obfuscated PHP code appended at the end as shown below.

![PHP appended](/images/2025-01-18-Flare-On-2014-C2/2.png)
...
Now, decoding the value `JGNvZGU9YmFzZTY0X2RlY29kZSgkXyk7ZXZhbCgkY29kZSk7` of variable `$__` from base64, the value is `code=base64_decode($_);eval($code);` 
- So, the above script will decode `$_` variable from base64 and execute it.
