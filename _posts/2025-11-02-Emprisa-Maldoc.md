...
In the above dump, there are sequence of NOP (`0x90`) instructions starting offset `0x961`, which are commonly used as padding within shellcode. Consequently, those part of the data following the NOP instruction was extracted as can be seen below, and saved as `shellcode.bin`: 
...
00000130: 00 00 F0 01 00 00 03 00  00 00 00 00              ............</code></pre>
